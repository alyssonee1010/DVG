    ...
    class CinemachineSettings : AssetPostprocessor
    {
            ...
            string[] movedFromAssetPaths, bool didDomainReload)
        {
            if (didDomainReload)
            {
                ...
                EditorApplication.hierarchyWindowItemByEntityIdOnGUI += (entityId, r) =>
                    DrawBrainIcon(EditorUtility.EntityIdToObject(entityId) as GameObject, r);
#else
                EditorApplication.hierarchyWindowItemOnGUI += (instanceID, r) =>
                    DrawBrainIcon(EditorUtility.InstanceIDToObject(instanceID) as GameObject, r);
#endif
            }
        }

        static void DrawBrainIcon(GameObject instance, Rect r)
        {
            if (instance == null)
